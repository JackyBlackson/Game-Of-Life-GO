...
public class ChunkGenerator {
    public static Chunk generate(Pos chunkPos){
        ...
        randx.setSeed((long) (WorldInfo.SeedOfWorld + chunkPos.getX()));
        Random randy = new Random();
        randx.setSeed((long) (WorldInfo.SeedOfWorld + chunkPos.getY()));
        ...
        Log(Importance.INFO, "Generating chunks at " + chunkPos.toString() + " (Chunk Coordinate)");
        return c;
    }
